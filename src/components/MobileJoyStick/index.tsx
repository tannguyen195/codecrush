    ...
    return (
        <div className="w-full absolute transform -translate-y-1/2 bottom-16 z-10 flex items-center justify-center ">
            ...
            <div className="flex items-center justify-around w-full">
                <button onPointerDown={handlePointerWalkDown} onPointerUp={handlePointerWalkUp} className="rounded-full w-[50px] h-[50px] select-none touch-none"></button>
                <button onPointerDown={handlePointerSprintDown} onPointerUp={handlePointerSprintUp} className="rounded-full w-[50px] h-[50px] select-none touch-none"></button>
            </div>
        </div>
    );
}
